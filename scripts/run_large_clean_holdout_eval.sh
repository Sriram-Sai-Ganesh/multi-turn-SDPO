...
HOLDOUT_MODEL_NAME="${HOLDOUT_MODEL_NAME:-Qwen/Qwen3-8B}"
...
REVEAL_RUN_SUFFIX=""
if [ "$SHARDED_REVEAL_POLICY" != "always" ]; then
    REVEAL_RUN_SUFFIX="-$SHARDED_REVEAL_POLICY"
fi
BASE_RUN="${RUN_PREFIX}-base${REVEAL_RUN_SUFFIX}-512"
DENSE_RUN="${RUN_PREFIX}-dense-rlrf-shuffle7-60${REVEAL_RUN_SUFFIX}-512"
